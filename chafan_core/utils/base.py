...
ErrorMsg = Union[
    ...
    Literal["The application doesn't exist in the system."],
    Literal["Unauthorized."],
    Literal["The submission doesn't exist in the system."],
    Literal["You can't invite yourself."],
    Literal["Incorrect email or password"],
    Literal["The reward doesn't exist in the system."],
    Literal["Invalid site UUID"],
    Literal["The article_column doesn't exist in the system."],
    ...
    Literal["The form doesn't exist in the system."],
    ...
    Literal["The site doesn't exist in the system."],
    ...
    Literal["The answer doesn't exist in the system."],
    ...
    Literal["Frontend bug: repeated posting in one writing session."],
    ...
    Literal["The question doesn't exist in the system."],
    Literal["Wrong form."],
    Literal["User not found"],
    Literal["The channel doesn't exist in the system."],
    ...
    Literal["The submission_suggestion doesn't exist in the system."],
    Literal["The article doesn't exist in the system."],
    ...
    Literal["The message doesn't exist in the system."],
    ...
    Literal["The followed_user doesn't exist in the system."],
    Literal["The comment has too many or too few parent ids."],
    Literal["Author can't upvote authored submission."],
    Literal["The receiver doesn't exist in the system."],
    ...
    Literal["The circle doesn't exist in the system."],
    ...
    Literal["The user doesn't exist in the system."],
    ...
    Literal["Question has at least one answer."],
    ...
    Literal["The answer_suggest_edit doesn't exist in the system."],
