...
class ViewCountArticle(Base):
    __table_args__ = (
        UniqueConstraint("article_id", "view_count"),
        PrimaryKeyConstraint("article_id", "view_count"),
    )
...
class ViewCountQuestion(Base):
    __table_args__ = (
        UniqueConstraint("question_id", "view_count"),
        PrimaryKeyConstraint("question_id", "view_count"),
    )
...
class ViewCountAnswer(Base):
    __table_args__ = (
        UniqueConstraint("answer_id", "view_count"),
        PrimaryKeyConstraint("answer_id", "view_count"),
    )
